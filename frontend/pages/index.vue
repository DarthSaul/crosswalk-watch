...
<template>
  <section class="home">
    <header class="hero">
      ...
      <h1>Watch any intersection like an analyst.</h1>
      <p class="lede">
        Crosswalk Watch is a fullstack demo that turns a video clip into something you can
        actually measure: tracked people and vehicles, named polygon zones,
        and per-zone stats — entries, dwell, occupancy over time.
      </p>
    ...
    <section class="try">
      ...
      <div class="try-grid">
        <div class="card try-card">
          <h3>Use a sample</h3>
          <p class="muted">Pre-loaded crosswalk clips. Click one to get a job in seconds.</p>
        ...
        <div class="card try-card">
          ...
          <p class="muted">
            Drop in any <code>.mp4</code> up to 200&nbsp;MB. We extract a thumbnail at
            t≈1.0s so you can draw zones before analysis kicks off.
          </p>
...
.tool-label { color: var(--muted); font-size: 11px; }
